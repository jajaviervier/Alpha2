...
<div class="col-md-4 ">
  ...
  <div class="form-group">
    <input type="submit" class="class="btn btn-primary"" value="Filtrar">
  </div>
</div>
   <!--Fin Hasta -->
...
<table class="table  table-dark  table-responsive"   id="tablaAccesorios"><!--como llamar la otra funcion para cambiar el idioma? -->
        <thead>
          <tr>
            <th scope="col">#</th>
