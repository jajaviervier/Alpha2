	...
	$("body .table-dark").on("click", ".btnEditarCrearQuimicos", function(){
		...
		$.ajax({
			...
			success: function(respuesta) {
                ...
                $('#formu-editar-CrearQuimicos input[name="cantidadCrearQuimicos"]').val(valor.cantidadCrearQuimicos)
                $('#formu-editar-CrearQuimicos input[name="consumoCrearQuimicos"]').val(valor.consumoCrearQuimicos)
                $('#formu-editar-CrearQuimicos input[name="stockCrearQuimicos"]').val(valor.stockCrearQuimicos)
