...
console.log(datos)
	...
	$("#formu-editar-Accesorios").submit(function (e) {
		e.preventDefault()
	...
	$("body .table-dark").on("click", ".btnEditarAccesorios", function(){
		...
		$.ajax({
			...
			success: function(respuesta) {
				...
				$('#formu-editar-Accesorios input[name="obserAccesorios"]').val(valor.obserAccesorios)
                ...
                $('#formu-editar-Accesorios select[name="estado"]').val(valor.estado)
