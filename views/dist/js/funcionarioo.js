	...
	$("body .table-dark").on("click", ".btnEditarFuncionarioo", function(){
		...
		$.ajax({
			...
			success: function(respuesta) {
				...
				console.log(valor.serieFuncionarioo)
				...
				$('#formu-editar-Funcionarioo input[name="serieFuncionarioo"]').val(valor.serieFuncionarioo)
				$('#formu-editar-Funcionarioo input[name="tipoFuncionarioo"]').val(valor.tipoFuncionarioo)
				$('#formu-editar-Funcionarioo select[name="idArmasForanea"]').val(valor.idArmasForanea)
				$('#formu-editar-Funcionarioo select[name="estado"]').val(valor.estado)
				$('#formu-editar-Funcionarioo textarea[name="observacionitemArma"]').val(valor.observacion)
