	...
	$("body .table-dark").on("click", ".btnEditarcrearAcc", function(){
		...
		$.ajax({
			...
			success: function(respuesta) {
				...
				$('#formu-editar-crearAcc input[name="seriecrearAcc"]').val(valor.seriecrearAcc)
				$('#formu-editar-crearAcc input[name="obsercrearAcc"]').val(valor.obsercrearAcc)
                $('#formu-editar-crearAcc textarea[name="descrearAcc"]').val(valor.descrearAcc)
                $('#formu-editar-crearAcc input[name="cantidadcrearAcc"]').val(valor.cantidadcrearAcc)

                $('#formu-editar-crearAcc select[name="estado"]').val(valor.estado)
